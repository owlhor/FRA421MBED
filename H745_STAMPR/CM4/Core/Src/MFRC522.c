 ...
 * MFRC522.c
 *
 *  Created on: 27 Nov 2565
 *      Author: Hamid-R-Tanhaei
 *      Edit&mod :  owl_hor
 */

#define MFRC522_enable
 ...
 * Description: Open antennas, each time you start or shut down the natural
...
/*
  ...
  * Description: Close antennas, each time you start or shut down the natural
  * 			barrier between the transmitter should be at least 1ms interval
  * 			Set 0 to Tx1RFEn, Tx2RFEn
  * Input: None
  * Return value: None
 */
