...
//=============================================================================
#define LCDMANAGERRR_OHLock
#ifdef LCDMANAGERRR_OHLock

/* Lcd controll pins assign (A..K, 0..15) */
#define LCD_CS            B, 1
#define LCD_RS            C, 3
#define LCD_WR            C, 0
#define LCD_RD            A, 3  /* If not used leave it that way */
#define LCD_RST           C, 2  /* If not used leave it that way */

/* Lcd data pins assign (A..K, 0..15) */
#define LCD_D0            G, 9
#define LCD_D1            D, 15	 		//// Arduino Uno compat for MB1363 / H7 series
#define LCD_D2            G, 14
#define LCD_D3            E, 13
#define LCD_D4            E, 14
#define LCD_D5            E, 11
