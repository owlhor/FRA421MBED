...
//////// BRR in F103 == BSRR.BS in H7 (shift up 1 row __ 16 bit),
#define TFT_BL_H()	ST7735_BL_GPIO_Port -> BSRR = ST7735_BL_Pin
#define TFT_BL_L()	(ST7735_BL_GPIO_Port + 16) -> BSRR 	= ST7735_BL_Pin
#define TFT_CS_H()	ST7735_CS_GPIO_Port -> BSRR = ST7735_CS_Pin
#define TFT_CS_L()	(ST7735_CS_GPIO_Port + 16) -> BSRR 	= ST7735_CS_Pin
#define TFT_DC_D()	ST7735_DC_GPIO_Port -> BSRR = ST7735_DC_Pin
#define TFT_DC_C()	(ST7735_DC_GPIO_Port + 16) -> BSRR	= ST7735_DC_Pin
#define TFT_RES_H()	ST7735_RES_GPIO_Port -> BSRR = ST7735_RES_Pin
#define TFT_RES_L()	(ST7735_RES_GPIO_Port + 16) -> BSRR	 = ST7735_RES_Pin
